...
{\raggedright\large Developer \\ \small\textit{iVantage Health Analytics}}
\begin{itemize}
...
{\raggedright\large Hall Staff \\ \small{\textit{Department of Campus Life}, Colby College}}
\begin{itemize}
...
\textit{Experience with: Spring, Dependency Injection, Dynamic Proxies, Network Proxying, RAID, bash, HTTP, MVN, Git, Tomcat6, Hibernate, Transactions, REST, JSON-schema } \\[6pt]}
